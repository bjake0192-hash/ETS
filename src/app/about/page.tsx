...
export default function AboutPage() {
  ...
  return (
    <main>
      ...
      {/* Mission Section */}
      <div className="bg-background py-16 sm:py-24 border-t border-navy-900/10">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 sm:gap-16 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black text-navy-900 mb-6 uppercase tracking-tight">Our Mission</h2>
              <p className="text-navy-900/70 text-base sm:text-lg leading-relaxed mb-8">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3">
                    <CheckCircle2 size={18} className="text-electric-yellow" />
                    <span className="text-navy-900 font-bold uppercase text-xs sm:text-sm tracking-wider">{item}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden border border-navy-900/10 shadow-2xl aspect-[4/3] md:aspect-auto md:h-[600px] relative">
      ...
      {/* Core Values Section */}
      <div className="bg-[#fbf8f4] py-16 sm:py-24 border-t border-navy-900/10">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            <span className="text-electric-yellow font-black tracking-widest uppercase text-[10px] sm:text-sm mb-4 block">Our Principles</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-navy-900 uppercase tracking-tight">Core Values</h2>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {values.map((value, idx) => (
              <div key={idx} className="bg-white p-6 sm:p-8 rounded-[2rem] border border-navy-900/10 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="scale-90 sm:scale-100 origin-left">
                  {value.icon}
                </div>
                <h3 className="text-lg sm:text-xl font-black text-navy-900 mb-3 sm:mb-4">{value.title}</h3>
                <p className="text-navy-900/60 text-sm sm:text-base leading-relaxed">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-charcoal-900 py-20 sm:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            <div className="w-full lg:w-1/2">
              <span className="text-electric-yellow font-black tracking-widest uppercase text-[10px] sm:text-sm mb-4 block">The ETS Journey</span>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-8 uppercase tracking-tight leading-tight">Built on <br className="hidden sm:block" /><span className="text-white/40">Experience</span></h2>
            ...
            <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-4 sm:pt-12">
                <div className="bg-white/5 border border-white/10 p-5 sm:p-6 rounded-2xl">
                  <p className="text-2xl sm:text-3xl font-black text-electric-yellow mb-2">25+</p>
                  <p className="text-white/70 text-xs sm:text-sm">Years of foundational industry experience driving our technical standards.</p>
                </div>
                <div className="bg-white/5 border border-white/10 p-5 sm:p-6 rounded-2xl">
                  <p className="text-2xl sm:text-3xl font-black text-electric-yellow mb-2">2014</p>
                  <p className="text-white/70 text-xs sm:text-sm">ETS Ltd officially incorporated, focusing on high-end commercial installations.</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-white/5 border border-white/10 p-5 sm:p-6 rounded-2xl">
                  <p className="text-2xl sm:text-3xl font-black text-electric-yellow mb-2">Growth</p>
                  <p className="text-white/70 text-xs sm:text-sm">Achieved top-tier accreditations (NICEIC, SafeContractor) ensuring compliance-led delivery.</p>
                </div>
                <div className="bg-white/5 border border-white/10 p-5 sm:p-6 rounded-2xl">
                  <p className="text-2xl sm:text-3xl font-black text-electric-yellow mb-2">Today</p>
                  <p className="text-white/70 text-xs sm:text-sm">Leading nationwide provider of complex infrastructure and commercial fit-outs.</p>
                </div>
              </div>
            </div>
          </div>
