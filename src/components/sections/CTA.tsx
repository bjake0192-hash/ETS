  ...
  return (
    <section id="contact" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="bg-white rounded-3xl p-12 md:p-24 border border-navy-900/10 relative overflow-hidden shadow-2xl">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6">
              <button className="bg-electric-yellow text-navy-900 px-10 py-5 rounded-full font-black flex items-center gap-3 hover:bg-white transition-all transform hover:scale-105 shadow-2xl shadow-electric-yellow/20">
